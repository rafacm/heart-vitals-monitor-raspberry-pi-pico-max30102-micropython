...
Heart vitals monitor using Raspberry Pi Pico 2W, a MAX30102 heart rate sensor and a 128×64 OLED display both connected to the Pico via the I2C bus.

## Hardware

Both devices share a single I2C bus running at 400 kHz:
